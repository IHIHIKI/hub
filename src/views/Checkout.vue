...
class Checkout extends Vue {
    ...
    private dimensionsUpdateDelay: number = -1;
    ...
    private _onResize() {
        ...
        clearTimeout(this.dimensionsUpdateDelay);
        this.dimensionsUpdateDelay = window.setTimeout(() => (this.$refs.carousel as Carousel).updateDimensions(), 150);
    }
}
